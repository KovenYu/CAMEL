%% Interface of CAMEL_supervised.p
% Usage: dist = CAMEL_supervised(data4training, lambda, ...
%                     Gal, Prb, para)
%
% INPUT:
%
...
% probe samples.
% para.labelTrain, a 1-by-n array containing labels of training samples.
...
for i = 1:10
    ...
    tic
    dist = CAMEL_supervised(data4train, lambda, Gal, Prb, para);
