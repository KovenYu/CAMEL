...
rng(1);
tic
fprintf('CAMEL running. This may take several minutes in Market-1501 ..\n')
U = CAMEL(data4train, K, lambda, para);
fprintf('Running time of CAMEL: %f seconds \n', toc);
...
disp('The results might be a little bit different from the published results,')
disp('depending on the MATLAB version and machine setting.')